...
(function() {
var contentEditor = angular.module('app');
		...
		return {
			...
			link: function($scope, $element, $attrs) {
				$element.on("mousedown", function($event) {
					var newNode = $compile(
						'<div id="graph-wrapper" class="contentEditorBox" ce-drag ce-resize><div style="padding:5px">Mein Graph</div></div>'
					)($scope);
					...
					angular.element( document.querySelector( '#some-id' ) ).append(newNode);
